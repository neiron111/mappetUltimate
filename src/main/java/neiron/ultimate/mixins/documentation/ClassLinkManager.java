...
import neiron.ultimate.mixins.documentation.mixin.late.MixinGuiDocumentationOverlayPanelAccessor;
...
public class ClassLinkManager {
    ...
    private GuiSimpleContextMenu createContextMenu(Set<DocEntry> entries) {
        ...
        for (DocEntry entry : entries) {
            ...
            menu.action(MPIcons.IN, IKey.format("mappet.gui.scripts.context.docs", key), () -> openOverlay(entry), Ultimate.mainColor);
        }
        return menu;
    }
